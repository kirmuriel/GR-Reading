...
Book.createBook = function (title, hash) {
	return Object.create(Book,{
		...
		rawReadUpdates:{value:[], enumerable:true},
		dailyUpdates:{value:null, enumerable:true},
		totalPages:{value:0, enumerable:true},
		finishedOn:{value:0, enumerable:true},
		shelf:{value:Book.Shelves.Other, enumerable:true},
		needsUpdate:{value:true, enumerable:true},
		bookId:{value:-1, enumerable:true}
	});
};
