...
Util.getOffset = function (date) {
	...
	//var current_date = ;
	// Remove hour
	return (date + (Util.HOUR_IN_MSEC * current_offset));
};
...
var Book = function (title, hash) {
	...
	this.totalPages = this.finishedOn = 0;
